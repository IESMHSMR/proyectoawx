...
#PROJECT_ORG="Default"
## For projects:
#PROJECT_URL="https://github.com/ansible-roles.git"
#PROJECT_BRANCH="jpcarmona"
## Playbook:
#PLAYBOOK_FILE="ansible/playbook-docker.yml"
## Inventory:
#INVENTORY_FILE="inventories/dns-servers.yml"
##For credentials:
...
#VARS_TO_LAUNCH="
#{ "docker_registry_url": "docker-registry..com:443/",
#"user":"jpcarmona", "pass": "$PASSWORD",
#"docker_image_name": "-docker-bind9:latest",
